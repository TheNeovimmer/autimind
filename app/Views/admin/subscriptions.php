<div class="dash-header">
  ...
  <a href="/admin/subscriptions/add" class="btn-primary"><i class="fas fa-plus"></i> Add Subscription</a>
</div>
    ...
    <tbody>
      <?php foreach ($subscriptions as $s): ?>
        <tr>
          ...
          <td>
            <a href="/admin/subscriptions/<?= (int)$s['id'] ?>/edit" class="btn-sm btn-outline">Edit</a>
            <form method="POST" action="/admin/subscriptions/<?= (int)$s['id'] ?>/delete" style="display:inline;" onsubmit="return confirm('Delete this subscription?')">
