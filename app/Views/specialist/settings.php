...
<form method="POST" action="/specialist/settings" class="" enctype="multipart/form-data">
    ...
    <div class="avatar-upload-wrapper">
      ...
      <div>
        <div class="avatar-upload-btn">
          ...
          <input type="file" name="avatar" class="" accept="image/jpeg,image/png,image/webp,image/gif">
        </div>
  ...
  <div class="card mb-2">
    ...
    <div class="dash-field">
      <label>Email</label>
      <input type="email" class="" value="<?= htmlspecialchars($user['email']) ?>" disabled>
    </div>
    <div class="dash-field">
      <label for="phone">Phone</label>
      <input type="text" id="phone" name="phone" class="" value="<?= htmlspecialchars($old['phone'] ?? $user['phone'] ?? '') ?>">
    </div>
  </div>

  <div class="card mb-2">
    <h3>Change Password</h3>
    <p class="dash-text-muted">Leave blank to keep current.</p>
    <div class="dash-field">
      <label for="password">New Password</label>
      <div class="password-wrapper">
        <input type="password" id="password" name="password" class="" minlength="8">
